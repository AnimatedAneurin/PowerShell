...
;    1.0.3    26/05/2021  Added new URL's and Scripts. Updated GUI to represent DLM.
;    1.0.4    15/06/2021  Temporarily disabled submenu 6 through 8 as it's unrelated to DLM, may be added back in future patch if a relevant replacement is found.
;
;
;
;
...
; Create another menu destined to become a submenu of the above menu.
Menu, Submenu2, Add, Application Deployment Evaluation Cycle, applicationDeploymentEvaluationCycle, MenuHandler
...
Menu, Submenu2, Add, Hardware Inventory Cycle, hardwareInventoryCycle, MenuHandler
Menu, Submenu2, Add, Machine Policy Evaluation Cycle, machinePolicyEvaluationCycle, MenuHandler
Menu, Submenu2, Add, Machine Policy Retrieval Cycle, machinePolicyRetrievalCycle, MenuHandler
...
Menu, Submenu2, Add, User Policy Evaluation Cycle, userPolicyEvaluationCycle, MenuHandler
Menu, Submenu2, Add, User Policy Retrieval Cycle, userPolicyRetrievalCycle, MenuHandler


; Create another menu destined to become a submenu of the above menu.
Menu, Submenu3, Add, Check-Up-Time, checkUpTime, MenuHandler
Menu, Submenu3, Add, Current Logged on User, currentLoggedOnUser, MenuHandler
Menu, Submenu3, Add, Custom Reboot, customReboot, MenuHandler
Menu, Submenu3, Add, Force Reboot, forceReboot, MenuHandler
Menu, Submenu3, Add, Get GUID, getGUID, MenuHandler
Menu, Submenu3, Add, Install SCCM Client, installSCCMClient, MenuHandler
Menu, Submenu3, Add, Run PS1 File, runPS1File, MenuHandler
Menu, Submenu3, Add, Single Powershell Command, singlePowershellCommand, MenuHandler
Menu, Submenu3, Add, Uninstall SCCM Client, uninstallSCCMClient, MenuHandler
...
;Menu, Submenu5, Add, DLM Ensemble URL, DLMEnsemble, MenuHandler
...
Menu, Submenu5, Add, Microsoft Update Catalog URL, MicrosoftUpdateCatalog, MenuHandler
